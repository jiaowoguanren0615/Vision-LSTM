...
from .threeaugment import GaussianBlur, horizontal_flip
...
def build_transform(is_train, args):
    ...
    if is_train:
        ...
        # transform.transforms.append(GaussianBlur(radius_min=0.1, radius_max=2.))
        # transform.transforms.append(horizontal_flip(p=0.5))
        # print("Successfully add GaussianBlur & RandomHorizontalFlip to train-set!!!")
        return transform
