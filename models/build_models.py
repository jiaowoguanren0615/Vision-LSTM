...
from .vision_lstm_utils import interpolate_sincos, to_ntuple, VitPatchEmbed, VitPosEmbed2d, DropPath
...
class VisionLSTM(nn.Module):
    def __init__(
        ...
        assert self.nb_classes is not None, \
                f"define number of classes via nb_classes=num_classes (e.g. nb_classes=1000 for ImageNet-1K"
        self.head = nn.Linear(dim, self.nb_classes)
...
@register_model
def vil_tiny(nb_classes=1000, pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs):
    # https://ml.jku.at/research/vision_lstm/download/vil_tiny16_e800_in1k.th
    dim = 192
    depth = 24
    legacy_norm = True
    model = VisionLSTM(nb_classes=nb_classes, dim=dim, depth=depth, legacy_norm=legacy_norm, **kwargs)
    return model


@register_model
def vil_tiny_plus(nb_classes=1000, pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs):
    # https://ml.jku.at/research/vision_lstm/download/vil_tinyplus16_e800_in1k.th
    dim = 192
    depth = 29
    legacy_norm = True
    model = VisionLSTM(nb_classes=nb_classes, dim=dim, depth=depth, legacy_norm=legacy_norm, **kwargs)
...
@register_model
def vil_tiny_plus_stride8(nb_classes=1000, pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs):
    # https://ml.jku.at/research/vision_lstm/download/vil_tinyplus16_e800_in1k.th
    dim = 192
    depth = 29
    stride = 8
    legacy_norm = True
    model = VisionLSTM(nb_classes=nb_classes, dim=dim, depth=depth, legacy_norm=legacy_norm, stride=stride, **kwargs)
    return model



@register_model
def vil_small(nb_classes=1000, pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs):
    # https://ml.jku.at/research/vision_lstm/download/vil_small16_e400_in1k.th
    dim = 384
    depth = 24
    legacy_norm = True
    model = VisionLSTM(nb_classes=nb_classes, dim=dim, depth=depth, legacy_norm=legacy_norm, **kwargs)
...
@register_model
def vil_small_plus(nb_classes=1000, pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs):
    # https://ml.jku.at/research/vision_lstm/download/vil_smallplus16_e400_in1k.th
    dim = 384
    depth = 26
    legacy_norm = True
    model = VisionLSTM(nb_classes=nb_classes, dim=dim, depth=depth, legacy_norm=legacy_norm, **kwargs)
...
@register_model
def vil_samll_plus_stride8(nb_classes=1000, pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs):
    # https://ml.jku.at/research/vision_lstm/download/vil_smallplus16_e400_in1k_stride8.th
    dim = 384
    depth = 26
    stride = 8
    legacy_norm = True
...
@register_model
def vil_base(nb_classes=1000, pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs):
    # https://ml.jku.at/research/vision_lstm/download/vil_base16_e400_in1k.th
    dim = 768
    depth = 24
    legacy_norm = True
    model = VisionLSTM(nb_classes=nb_classes, dim=dim, depth=depth, legacy_norm=legacy_norm, **kwargs)
...
@register_model
def vil_base_stride8(nb_classes=1000, pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs):
    # https://ml.jku.at/research/vision_lstm/download/vil_base16_e400_in1k_stride8.th
    dim = 768
    depth = 24
    stride = 8
    legacy_norm = True
