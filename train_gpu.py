...
def get_args_parser():
    parser = argparse.ArgumentParser(
        'VisionLSTM training and evaluation script', add_help=False)
    ...
    # Model parameters
    parser.add_argument('--model', default='vil_base', type=str, metavar='MODEL',
                        choices=['vil_tiny', 'vil_tiny_plus', 'vil_tiny_plus_stride8',
                                 'vil_small', 'vil_small_plus', 'vil_samll_plus_stride8',
                                 'vil_base', 'vil_base_stride8'
                                 ],
...
def main(args):
    ...
    print("***********************************")
    print(f'ESTABLISH ARCHITECTURE: {args.model}\n')
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        'VisionLSTM training and evaluation script', parents=[get_args_parser()])
